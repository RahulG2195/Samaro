        ...
        <>
            ...
            <div className="container">
                <div className="row justify-content-center align-items-center mb-5">
                    <h1 className="text-center text-danger fw-bold">Product Specification</h1>
                    <div className="col-7 productSpecification">
                    ...
                    <div className="col-5">
                        <img src="/uploads/spcLayers.png" alt="SPC Layers" className="spec-image" />
                    </div>
                </div>
            </div>
