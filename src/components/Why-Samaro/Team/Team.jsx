...
const Team = () => {
  ...
  return (
    <>
      <div>
        <div className="text-center my-md-5 my-3 container">
          <h1 className="text-center mt-5 text-navy fw-bold ">
           <u className="border-danger border-bottom border-2"> Our Leadership Team</u>
          </h1>
          <p className="fw-semibold px-0 px-md-5 px-lg-5">
