...
--
-- Host: localhost:3306
-- Generation Time: Sep 23, 2024 at 06:01 AM
...
CREATE TABLE `benefits` (
  ...
  `icons` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `titles` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `slider_images` varchar(4096) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'ClickCore tiles benefits', 'dust-free.png,scratch.png,lock.png,waterproof.png,stain-protection.png,termite.png,glue-free.png,fire-resistant.png,durability.png,recyclable.png,waterproof.png', '1-DAY INSTALLATION,DUST FREE INSTALLATION,100% WATERPROOF,SCRATCH RESISTANT,STAIN PROTECTION,TERMITE PROOF,GLUE FREE APPLICATION,FIRE RESISTANT,DURABLE,100% RECYCLABLE,WEATHER PROOF', 'Mask Group 325.png,Mask Group 324.png,Mask Group 322.png,Mask Group 323.png');
...
(1, 'Vision', 'Vision', 'We aim to be a global leader in building materials, setting new standards in innovation and design. From homes to commercial spaces, our goal is to create products that inspire, endure, and elevate spaces for generations.', 'vision.png', '2024-06-19 04:54:26', '2024-09-20 11:05:17'),
(2, 'Mission', 'Mission', 'At Samaro Flooring, we create flooring solutions that combine style, comfort, and sustainability. Using cutting-edge technology and eco-friendly materials, we aim to enhance every space while contributing to a more sustainable future in building materials.', 'mission.png', '2024-06-19 04:54:26', '2024-09-20 11:05:17');
